...
with open('data/user_item_model.parquet', 'rb') as archivo:
...
def developer(desarrollador):
    ...
    funcion_1=pd.read_parquet("data/games.parquet")
...
def user_data(user_id):
    ...
    """
    # Abrimos el archivo parquet en un dataframe
    funcion_2 = pd.read_parquet('data/games_reviews.parquet')
...
def User_For_Genre(genero):
    ...
    """
    # Abrimos el archivo parquet en un dataframe
    funcion_3 = pd.read_parquet('data/games_items.parquet')
...
def best_developer_year(year):
    ...
    """
    # Abrimos el archivo parquet en un dataframe
    funcion_4 = pd.read_parquet('data/games_reviews.parquet')
...
def desarrollador_reviews_analysis(desarrolladora):
    ...
    """
    # Abrimos el archivo parquet en un dataframe
    funcion_5 = pd.read_parquet('data/games_reviews.parquet')
...
def recomendacion_juego(item_id):
    ...
    data = pd.read_parquet('data/item_item.parquet')
...
def recomendacion_usuario(user_id):
    ...
    new_df = pd.read_parquet('data/user_item_model.parquet')
